...
Define the Pop Agent Web v1 frontend workspace, including its handoff-faithful visual system, generation states, mock/API data seams, and local build requirements.
