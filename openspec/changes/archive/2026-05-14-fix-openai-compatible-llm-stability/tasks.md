...
- [x] Show CLI generation progress through the existing progress callback.
- [x] Gracefully ignore unreadable or malformed user config files.
- [x] Add tests for environment aliases and endpoint normalization.
